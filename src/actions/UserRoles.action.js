...
export const SET_SORTING = 'SET_SORTING_USER_ROLES';
export const SET_FILTER = 'SET_FILTER_USER_ROLES';
export const SET_PAGE = 'SET_PAGE_USER_ROLES';
export const CHANGE_PAGE = 'CHANGE_PAGE_USER_ROLES';
export const CHANGE_STATUS= 'CHANGE_STATE_USER_ROLES';
export const SET_SERVER_PAGE = 'SET_SERVER_PAGE_USER_ROLES';
export const CREATE_DATA = 'CREATE_USER_ROLES';
export const UPDATE_DATA = 'UPDATE_USER_ROLES';
...
export function actionSetPageService(page) {
    ...
    if (totalLength <= ((page + 1) * Constants.DEFAULT_PAGE_VALUE)) {
        store.dispatch(actionFetchUserRoles(serverPage + 1, sortingData, {query, query_data: queryData}));
