...
class SidePanelComponent extends Component {
    ...
    render() {
        ...
        const tempStyle = {
            width: (this.state.delta == 0 || !this.props.open) ? 'calc(55vw)' : (window.innerWidth - this.state.delta),
            height: '100%',
        ...
        if (this.props.side == 'left') {
            tempStyle['left'] = (this.props.open ? '0px' : 'calc(-55vw)');
        } else {
            tempStyle['right'] = (this.props.open ? '0px' : 'calc(-55vw)');
        }
        return (
